...
function feFigStart(){
  ...
  s+=feT(60,base+44+22,'의무지급률: 금액이 작을수록 높다 · 요청 후 14일 내 지급 · 선급금보증서(선금액 + 약정이자 이상)',{fs:12,c:FE_C.dim});
...
function feFigClaim(){
  ...
  var N=[[0,'기성 검사','완료된 만큼 확인'],[90,'기성 청구','대금청구서 · 검사조서'],[180,'기성대가 지급','청구일부터 5일 이내'],[270,'다음 공정','이어서 이행']];
